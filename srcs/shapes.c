...
/*   Updated: 2020/09/30 15:47:23 by nneronin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void	coord_position(t_info *info, t_shapes *l)
{
	...
	w = ((float)info->drawing_surface[0]->surface->w /
			(float)info->screen_surface->surface->w);
	h = ((float)info->drawing_surface[0]->surface->h /
			(float)info->screen_surface->surface->h);
